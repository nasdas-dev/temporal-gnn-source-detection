...
\put(0,140){\parbox[b]{100mm}{
    \begin{center}
    {\bf\Huge {\sffamily{Graph Neural Networks for Epidemic Source Detection on Temporal Contact Networks}}}
    \end{center}}}


\put(109,92){\parbox[b]{50mm}{
    {\bf
    {\sffamily{{\Large Dario Akhavan Safa}}}}\\
    {\sffamily{of Zurich ZH, Switzerland\\\\
    Student-ID: 15-133-317\\
    dario.akhavansafa@uzh.ch
    }}
}}
...
\put(109,32){\parbox[b]{50mm}{\flushleft
    {\sffamily{Advisor:}} {\bf {\sffamily{Nathan Brack}} }
    }
}
